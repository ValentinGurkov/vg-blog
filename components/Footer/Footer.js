    ...
    <div className={classes.footerTop}>
      <div className={classes.newsLetter}>
        ...
        <form>
          ...
          <button className={classes.footerButton} type='submit' value='Join now' onClick={newsLetterFormHandler}>
            <span>JOIN NOW</span>
          </button>
        </form>
      </div>
        ...
        <div className={classes.socialIcons}>
          <Link href='https://www.facebook.com'>
            <a title='Follow us on Facebook' target='_blank' rel='noopener'>
              <img className={classes.socialIcon} src='/static/social/facebook.svg' alt='Facebook icon' />
            </a>
          </Link>
          <Link href='https://plus.google.com/discover'>
            <a title='Follow us on Google+' target='_blank' rel='noopener'>
              <img className={classes.socialIcon} src='/static/social/googleplus.svg' alt='Google+ icon' />
            </a>
          </Link>
          <Link href='https://twitter.com'>
            <a title='Follow us on Twitter' target='_blank' rel='noopener'>
              <img className={classes.socialIcon} src='/static/social/twitter.svg' alt='Twitter icon' />
            </a>
          </Link>
          <Link href='https://instagram.com'>
            <a title='Follow us on Instagram' target='_blank' rel='noopener'>
              <img className={classes.socialIcon} src='/static/social/instagram.svg' alt='Instagram icon' />
            </a>
          </Link>
          <Link href='https://youtube.com'>
            <a title='Follow us on YouTube' target='_blank' rel='noopener'>
              <img className={classes.socialIcon} src='/static/social/youtube.svg' alt='YouTube icon' />
            </a>
          </Link>
        </div>
      </div>
