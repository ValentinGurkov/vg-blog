...
const privacyPolicy = () => {
  return (
    <div>
      ...
      <p>
        Valentin Gurkov's Blog ("us", "we", or "our") operates the
        http://www.vgblog.com website (hereinafter referred to as the
        "Service").
      </p>
      ...
      <p>
        ...
        in our Terms and Conditions, accessible from http://www.vgblog.com
      </p>
      ...
      <p>
        Valentin Gurkov's Blog uses the collected data for various purposes:
      </p>
      <ul>
      ...
      <p>
        If you are located outside Bulgaria and choose to provide information to
        us, please note that we transfer the data, including Personal Data, to
        Bulgaria and process it there.
      </p>
      <p>
      ...
      <p>
        Valentin Gurkov's Blog will take all steps reasonably necessary to
      ...
      <p>
        Valentin Gurkov's Blog may disclose your Personal Data in the good faith
        belief that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>
          To protect and defend the rights or property of Valentin Gurkov's Blog
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          By visiting this page on our website: http://www.vgblog.com/contact-us
        </li>

        <li>By phone number: +395886524579</li>
        <li>
          By mail: Anak Krakatau Island, Pulau, South Lampung Regency, Lampung,
          Indonesia
        </li>
        <li>
          By visiting our office: Anak Krakatau Island, Pulau, South Lampung
          Regency, Lampung, Indonesia
          <Map />
        </li>
      </ul>
    </div>
