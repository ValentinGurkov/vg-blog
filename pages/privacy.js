...
const privacyPolicy = () => (
  <div>
    ...
    <p>
      Valentin Gurkov's Blog ("us", "we", or "our") operates the http://www.vgblog.com website (hereinafter referred to
      as the "Service").
    </p>
    ...
    <p>
      ...
      this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from http://www.vgblog.com
    </p>
    ...
    <p>
      Valentin Gurkov's Blog may disclose your Personal Data in the good faith belief that such action is necessary to:
    </p>
    <ul>
    ...
    <p>
      The security of your data is important to us, but remember that no of transmission over the Internet, or method of
