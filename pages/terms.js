  ...
  return (
    <div>
      ...
      <p>
        ...
        carefully before using the http://www.vgblog.com website (the "Service")
        operated by Valentin Gurkov's Blog ("us", "we", or "our").
      </p>
      ...
      <p>
        ...
        Service. This Terms and Conditions agreement for Valentin Gurkov's Blog
        is managed by{' '}
        <a href='https://termsfeed.com/terms-conditions/generator/'>
          TermsFeed's Terms and Conditions Generator
        </a>
        .
      </p>
      ...
      <p>
        ...
        are not owned or controlled by Valentin Gurkov's Blog.
      </p>

      <p>
        Valentin Gurkov's Blog has no control over, and assumes no
        responsibility for, the content, privacy policies, or practices of any
        third party web sites or services. You further acknowledge and agree
        that Valentin Gurkov's Blog shall not be responsible or liable, directly
      ...
      <p>
        ...
        of Bulgaria, without regard to its conflict of law provisions.
      </p>
